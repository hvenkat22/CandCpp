...
int main(void) {
  ...
  while(1){
    printf("\nWelcome to the Singly Linked List Program! Enter 1 for Insertion, 2 for Deletion, or 0 to exit: ");
    scanf("%d",&choice);
    if(choice==1){
      ...
      if(within==4){
        ...
        printf("The Linked List after deletion at beginning: ");
        display(start);
        continue;
      }else if(within==5){
        ...
        printf("Linked List after Deletion After a node: ");
        display(start);
        continue;
      }else if(within==6){
        deleteAtEnd(start);
